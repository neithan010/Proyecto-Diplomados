...
$rut=$_REQUEST['RUT'];
 ...
 $this->Row(array('Hasta 15 días corridos antes del inicio del diploma.','5 UF'));

 $this->Row(array('Faltando menos de quince días corridos para el inicio del diploma.','15 UF'));
