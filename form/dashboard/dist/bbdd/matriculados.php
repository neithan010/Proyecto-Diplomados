...
where
	...
	CONCAT(p.etapa, p.estado) IN ('3030','3131') 
...
$objPHPExcel->getActiveSheet()->getStyle('A1:L1')->getFill()->getStartColor()->setARGB('FFC0C0C0');
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Matriculados');
...
header('Content-Disposition: attachment;filename="Matriculados '.$cod_diploma.'.xls"');
