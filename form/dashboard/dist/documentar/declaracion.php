...
<body>
    <div class="container">
    <form action="declaracion_df.php" id="form1" name="form1" method="POST">
        ...
        <div class="text-center">
            <input type="submit" class="btn btn-primary" name="firmaInsitu" id="firmaInsitu" value="Firma Insitu">
            
            <button class="btn btn-primary" id="btn_imp" >Firma Digital * </button> 
