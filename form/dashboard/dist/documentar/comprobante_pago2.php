...
//-------------------
/*
if($_REQUEST['giro_empresa']<>''){
    $pdf->SetFont('Arial','B',8);
    $pdf->Cell(40,5,'GIRO ','0',0,'L');
    $pdf->SetFont('Arial');
    $pdf->Cell(80,5,': '.utf8_decode($_REQUEST['giro_empresa'])  ,'0',0,'L');
    $pdf->Ln(4);
}
if($_REQUEST['mail_empresa']<>''){
    $pdf->SetFont('Arial','B',8);
    $pdf->Cell(40,5,'MAIL ','0',0,'L');
    $pdf->SetFont('Arial');
    $pdf->Cell(80,5,': '.utf8_decode($_REQUEST['mail_empresa'])  ,'0',0,'L');
    $pdf->Ln(4);
}
*/
//-------------------
...
if($nombre_empresa<>''){
    $facturar_a=$nombre_empresa;
}else{
    $facturar_a=utf8_decode($nombre_completo);
}
if($rut_empresa<>''){
    $facturar_rut=$rut_empresa;
}else{
    $facturar_rut=$rut;
}
if($direccion_empresa<>''){
    $facturar_direccion=$direccion_empresa;
}else{
    $facturar_direccion=utf8_decode($direccion);
}
...
//---------------
$monto_tx=isset($_REQUEST['monto_tx'])?$_REQUEST['monto_tx']:0;
$monto_tc=isset($_REQUEST['monto_tc'])?$_REQUEST['monto_tc']:0;
$monto_tc_wp=isset($_REQUEST['monto_tc_wp'])?$_REQUEST['monto_tc_wp']:0;
$monto_paypal=isset($_REQUEST['monto_paypal'])?$_REQUEST['monto_paypal']:0;
$monto_pat=isset($_REQUEST['monto_pat'])?$_REQUEST['monto_pat']:0;
$monto_pac=isset($_REQUEST['monto_pac'])?$_REQUEST['monto_pac']:0;
$monto_cuota_pac=isset($_REQUEST['monto_cuota_pac'])?$_REQUEST['monto_cuota_pac']:0;
$monto_oc=isset($_REQUEST['monto_oc'])?$_REQUEST['monto_oc']:0;
$monto_vv=isset($_REQUEST['monto_vv'])?$_REQUEST['monto_vv']:0;
$monto_tx_emp=isset($_REQUEST['monto_tx_emp'])?$_REQUEST['monto_tx_emp']:0;
$monto_tc_emp=isset($_REQUEST['monto_tc_emp'])?$_REQUEST['monto_tc_emp']:0;
$monto_tc_wp_emp=isset($_REQUEST['monto_tc_wp_emp'])?$_REQUEST['monto_tc_wp_emp']:0;
$monto_paypal_emp=isset($_REQUEST['monto_paypal_emp'])?$_REQUEST['monto_paypal_emp']:0;
$monto_pat_emp=isset($_REQUEST['monto_pat_emp'])?$_REQUEST['monto_pat_emp']:0;
$monto_oc_emp=isset($_REQUEST['monto_oc_emp'])?$_REQUEST['monto_oc_emp']:0;
$monto_vv_emp=isset($_REQUEST['monto_vv_emp'])?$_REQUEST['monto_vv_emp']:0;

$total_descuento=$monto_tx+$monto_tc+$monto_tc_wp+$monto_paypal+$monto_pat+$monto_pac+$monto_cuota_pac+$monto_oc+$monto_vv+$monto_tx_emp+$monto_tc_emp+$monto_tc_wp_emp+$monto_paypal_emp+$monto_pat_emp+$monto_oc_emp+$monto_vv_emp;
...
//---------------------
if (in_array("tc", $arr_check_int) || in_array("webpay", $arr_check_int) || in_array("tc_emp", $arr_check_emp) || in_array("webpay_emp", $arr_check_emp)) {
    $pdf->AddPage();
