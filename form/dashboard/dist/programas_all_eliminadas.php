...
$arr_postulantes = _data_postulante($programa['id_programa'],'1010');                                           
?>
        <div class="card-body">
          <div class="table-responsive">
...
if(!empty($arr_postulantes)){
  foreach($arr_postulantes as $postulante){
                ...
                <tr>
                                                ...
                                                <td nowrap>
                                                  <?php if($postulante['fecha_estado_consultado']<>''){?>  
                                                    <span class="text-hide "><?php echo $postulante['fecha_estado_consultado'];?></span> <?php echo date("d/m/Y", strtotime($postulante['fecha_estado_consultado']));?>
                                                  <?php }?>  
                                                </td>
      ...
      <p><a
          href="https://intranet.unegocios.cl/apps/cdg/postulacion/admision/eliminados_excel.php?usr=<?php echo $usuario; ?>"
          target="_blank" rel="noopener noreferrer">Exportar datos Eliminados</a></p>
