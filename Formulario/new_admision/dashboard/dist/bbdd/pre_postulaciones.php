...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Pre postulaciones');
...
header('Content-Disposition: attachment;filename="Pre postulaciones '.$cod_diploma.'.xls"');
