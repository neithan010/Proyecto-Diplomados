...
$redes_sociales='<p>S&iacute;guenos en nuestras redes sociales:<br />
	...
	para ello debes ingresar al siguiente link https://unegocios.uchile.cl/paypal/ 
	...
	$asunto		= "Link de Pago Paypal – Universidad de Chile";
...
*/
		...
		$cabeceras .= "From:".$remitente."<".$remite.">". "\r\n";
	   	$cabeceras .= 'Cc:'.$cc.'' . "\r\n";
		//$cabeceras .= 'Bcc: llevio@fen.uchile.cl,anunez@unegocios.cl,fvaldes@unegocios.cl' . "\r\n";
	...
	if(mail($para, $titulo, $mensaje, $cabeceras)){
		...
		//--------------------------------------	
		mail("llevio@unegocios.cl", "Error envio clave pago Paypal", "Error envio clave pago Paypal para ".$para);
