...
if ($row_data = $stmt_data->fetch()){
    ...
    $mail_envio               = $row_rs_data_alumno['mail_envio'];


   echo $mensaje   = '<p>Estimado(a) '.$nombre_completo.'.</p>
	...
	<li><a href="https://intranet.unegocios.cl/apps/admision_2021/dashboard/dist/certinet/link_integracion_x_documento.php?id_postulacion='.$id_postulacion.'&documento=declaracion" target="_blank" rel="noopener noreferrer">Contrato prestaci&oacute;n de servicio</a></li>
    </ol>
