...
where
	...
	CONCAT(p.etapa, p.estado) IN ('2020') 
...
$objPHPExcel->getProperties()->setCreator("Admisión - Unegocios - Centro de Desarrollo Gerencial")
							 ...
							 ->setTitle("BBDD Aceptados no Matriculados")
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Aceptados no Matrículados');
...
header('Content-Disposition: attachment;filename="Aceptados no Matrículados '.$cod_diploma.'.xls"');
