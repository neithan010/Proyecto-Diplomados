...
$periodo_mod=$arr_cod_diploma[1].$arr_cod_diploma[2];
	...
	$this->Row(array('Plazo en que se efectúa la comunicación de retiro de Programa en que el alumno se matriculó','Valor a pagar a la Universidad por costos de administración y operacionales.'));
 
 	$this->Row(array('- Desde el día de la matrícula hasta transcurridos los 10 primeros días de iniciado el curso','- No rigen multas'));

	$this->Row(array('- Desde el día 11º de iniciado el diploma en adelante.','- Se pagará el valor proporcional de las horas transcurridas, en función del avance del Diploma tomando como base el arancel total del Programa (precio de lista), siendo la proporción mínima de pago, un 15 % del arancel total del Diploma respectivo.'));
...
function PrintChapter($num, $title, $file, $file2, $file3)
{
	...
	$this->MultiCell(85,5,'FACULTAD DE ECONOMÍA Y NEGOCIOS',0,'C',false);
...
$pdf->PrintChapter(1,'','contrato_cursos_p1.txt','contrato_cursos_p3.txt','contrato_cursos_p2.txt');
