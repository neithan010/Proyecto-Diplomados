...
materiales, administración y operacionales.'));
 ...
 $this->Row(array('Faltando menos de quince días corridos y hasta el día de inicio del diplomado.','15 UF'));

	  $this->Row(array('Desde el inicio de clases del diplomado en adelante.','Deberá pagar el proporcional de las horas cursadas sobre el arancel total, siendo la proporción mínima de pago, un 25% del arancel indicado total del diploma respectivo.'));
